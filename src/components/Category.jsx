  ...
  return (
    <div className="mb-10 px-4">
      <div className="flex items-center space-x-6 mb-10">
        <h2 className="text-2xl md:text-4xl font-bold text-primary">Category</h2>
        <hr className="text-secondary w-full" />
      </div>
      <div className="px-20 flex flex-wrap gap-5 justify-around items-center">
        <div className="border-2 w-22 h-22 rounded-full flex justify-center items-center cursor-pointer hover:bg-gray-300">
          <div>
